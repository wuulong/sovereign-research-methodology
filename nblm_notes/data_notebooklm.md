...
================================================================================
📂 FILE PATH: data/contributions/contrib_all.json
================================================================================
  ...
  "papers": [
    ...
    },
    {
      ...
      "meta_data": {
        ...
        "paper_extraction": {
          "core_question": "如何在線上學習與協作檢索（Collaborative Search）環境中，利用「個人知識圖譜 (PKG)」來表示使用者/學習者的個人資料與興趣，以同時提供高個人化、具解釋性的語意推薦，並兼顧安全防範與時間動態性？",
